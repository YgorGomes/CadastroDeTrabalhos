   ...
   <div class="container-fuild">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="sub-header">Nova Instituição de Ensino</h2>
          <div class="">
            <form action="escola" method="post">
             
              <div class="form-group">
                <label for="">Nome da Instituição: </label>
                <input type="text" class="form-control" id="nomeEscola" name="nomeEscola" placeholder="Nome da instituição de ensino">
              </div>
              <div class="form-group">
                <label for="">Endereço da Instituição: </label>
                <input type="text" class="form-control" id="endereco" name="endereco" placeholder="Endereço da instituição de ensino">
              </div>
              <div class="form-group">
                <label for="">Telefone da secretária: </label>
                <input type="text" class="form-control" id="telefone" name="telefone" placeholder="+55(11) xxxxx-xxxx">
              </div>
              
               ${msg}
              <div class="form-group">
              	<input type="submit" class="btn btn-success" id="salvar" value="Guardar informações da escola" >
              </div>
            </form>
