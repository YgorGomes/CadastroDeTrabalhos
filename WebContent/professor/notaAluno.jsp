            ...
            <table class="table table-striped">
             ...
             <tbody id="tabela">
               <tr>
                  ...
                  <td><input type="text" class="form-control" id="nota1" name="nota1"></td>
                  <td><input type="text" class="form-control" id="nota2" name="nota2"></td>
                  <td><input type="text" class="form-control" id="nota3" name="nota3"></td>
                </tr>
